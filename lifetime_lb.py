...
<div>
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <a class="nav-link active" href="#" id="lifetime" onclick="changeColor('lifetime')" >Lifetime</a>
        <a class="nav-link  "  id="threemonths" onclick="changeColor('threemonths')" href="threemonth.html">3 Months</a>
    ...
    <div class="center-heading" id="animatedHeading">LIFETIME LEADERBOARD</div>
        ...
        <div class="left">
            ...
            <div>
                ...
                <div class="leaderboard_container">
                    ...
                    <div style="display:flex; left: 90.28px; top: 445px; position: absolute; color: black; font-size: 20.46px; font-family: 'Poppins', sans-serif;font-weight: 600; line-height: 18.41px; word-wrap: break-word">{{ top_three_students[1].fullname }} </div>
                    ...
                    <div style="display:flex; left: 350.54px; top: 444.08px; position: absolute; color: black; font-size: 20.46px; font-family: 'Poppins', sans-serif;font-weight: 600; line-height: 18.41px; word-wrap: break-word">{{ top_three_students[2].fullname }} </div>
...
with open('/var/www/reports/lifelong.html', 'w') as file:
