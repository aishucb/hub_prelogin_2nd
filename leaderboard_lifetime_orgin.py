...
.nav-link {
    ...
    color: #E50000; /* Red color for links */
    font-size: 24px; /* Larger font size */
    font-family: 'Poppins', sans-serif; /* Poppins font */
    margin-right: 15px; /* Add spacing between links if needed */
...
.nav-link.active {
    color: #040404; /* Change color for active link */
    font-weight: bolder;
...
<a class="nav-link" href="#" id="lifetime" onclick="changeColor('lifetime')" href="lifetime.html">Lifetime</a>
<a class="nav-link  active"  id="threemonths" onclick="changeColor('threemonths')">3 Months</a>
<a class="nav-link" href="house1.html" id="groupboard" onclick="changeColor('groupboard')">House</a>
        ...
        <h1 style="font-size: 43px; font-family: 'Poppins', sans-serif;>THREE MONTH LEADERBOARD<h1>
        <div class="left">
            ...
            {% for mention in mentions %}
                <div class="special-mentions_card">
                    <div style="position: relative; ">
                        ...
                        <div style="width: 319px; height: 92.77px; left: 216px; top: 106.17px; position: relative; text-align: justify; color: black; font-size: 20px; font-family: 'Poppins', sans-serif;font-weight: 500; word-wrap: break-word;margin-top: 20px;">{{ mention.title_description }}<br/><br/></div>
